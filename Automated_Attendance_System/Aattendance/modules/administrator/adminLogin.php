<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-md-offset-3 col-lg-6">
      <form class="form-horizontal" id="loginForm" action="modules/administrator/verifyAdmin.php" method="post" data-toggle="validator">
    ...
    <div class="col-md-6 col-md-offset-3 col-lg-6">
      <form class="form-horizontal" action="index.php" method="post" id="studentForm" data-toggle="validator">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="rollno" maxlength="10" name="rollno" placeholder="Roll No." required>
        </div>
