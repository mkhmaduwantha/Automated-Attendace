...
<?php if (count($result)) : ?>
		...
		<div class="container">
			...
			<div class="col-md-12 col-lg-12">
			<?php
				if ($_POST['admin_student'] === 'y' && isset($_POST['rollno'])) {
                ...
                <div class="panel-body">
                  <p>Present Days out of Working Days:&nbsp;<strong>' . $present . '/' . $tlec . '</strong></p>
					...
					header("location:index.php?page=admin_dashboard&student=invalid");
				}
...
<?php else: ?>
	<?php header("location:index.php?page=admin_dashboard&student=invalid"); ?>
<?php endif; ?>