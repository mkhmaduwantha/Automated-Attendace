<?php
	...
	$sql = "SELECT student.name,sid,student.rollno FROM student NATURAL JOiN student_subject NATURAL JOIN user_subject where  `rollno`=$strno AND `uid`= $uid";
	...
	// $sql = "SELECT name,sid,rollno FROM student where `rollno`={$strno}";
			...
			<?php
                ...
                <div class="panel-body">
                  <p>Present Days out of Working Days:&nbsp;<strong>' . $present . '/' . $tlec . '</strong></p>
					...
					header("location:index.php?page=dashboard&student=invalid");
				}
...
<?php else: ?>
	<?php header("location:index.php?page=dashboard&student=invalid"); ?>
<?php endif; ?>