	...
	<div class="row">
		<div class="col-md-12 col-lg-12">
			<form action="" method="GET" class="form-inline" data-toggle="validator">
				...
				<input type="hidden" name="page" value="adminReports">
		...
		<div class="col-md-12">
			...
			<?php
				...
				if(isset($_GET['submit']) && !empty($_GET['sdate']) && !empty($_GET['edate']) && ($_GET['edate'] > $_GET['sdate']) && ($_GET['sdate']<$t) && ($_GET['edate']<$t))
				{
                    ...
                    $get_subject = "SELECT uid from user_subject where id=$selsub";
						$get_sub=$conn->query($get_subject);
						$get_rsub=$get_sub->fetchAll(PDO::FETCH_ASSOC);
						//print_r($rsub);
						$suid=$get_rsub[0]['uid'];
